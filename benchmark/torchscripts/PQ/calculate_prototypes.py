...
def main():
    ...
    if learning:
        ...
        trainingSet = torch.load('/home/yuhao/Documents/work/SUTD/AMM/codespace/AMMBench/benchmark/datasets/CCA_MNIST_train_A_minus_mean.pt')
        D = trainingSet.shape[1]
    ...
    if trainingSet != None:
        ...
        print("\nPrototype Learning: ", prototypes[0].shape, str(time.time() - t) + "s")
        model = MyModule(torch.stack(prototypes))
        save_model(model.to('cpu'), "/home/yuhao/Documents/work/SUTD/AMM/codespace/AMMBench/benchmark/torchscripts/PQ/prototypes_CCA_MNIST_train_A_minus_mean.pt", torch.zeros(5, 5))
