...
def main():
    ...
    groupBarTR.DrawFigureYLog(taskNames,procLat,methodTags, "Task", r'Processing Latency l (ms)', 5, 15, figPath + "ds_latency_TR", True)
    groupBarTR.DrawFigureYLog(taskNames,ammError,methodTags, "Task",r'AMM Error $\epsilon$ ', 5, 15, figPath + "ds_amm_error_TR", False)
    groupBarTR.DrawFigureYLog(taskNames,endError,methodTags, "Task",r'Application Error $e$ ', 5, 15, figPath + "ds_app_error_TR", False)
    #print(ipcAll)
