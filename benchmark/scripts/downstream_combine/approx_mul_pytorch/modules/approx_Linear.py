...
class approx_Linear(torch.nn.modules.Linear):
    ...
    def __init__(self, in_features, out_features, bias=True,
                 ...
                 sample_ratio_wu=None, minimal_k_wu=None, algo='mm'):
    ...
    def forward(self, input):
        if self.training is True:
            ...
            return approx_linear_func.apply(input, self.weight, self.bias, self.sample_ratio, self.minimal_k,self.sample_ratio_bwd,self.minimal_k_bwd,self.sample_ratio_wu,self.minimal_k_wu, self.algo)
