...
def main():
    ...
    commonBasePath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/results/AMME2E_1stream1static_lazy/"

    figPath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + "/figures/AMME2E_1stream1static_lazy/"
    
    # add the datasets here
    srcAVec=['datasets/ECO/wm2.mtx',"datasets/DWAVE/dwa512.mtx",'datasets/UTM/utm1700a.mtx','datasets/RDB/rdb2048.mtx','datasets/QCD/qcda_small.mtx',]
    srcBVec=['datasets/ECO/wm3.mtx',"datasets/DWAVE/dwb512.mtx",'datasets/UTM/utm1700b.mtx','datasets/RDB/rdb2048l.mtx','datasets/QCD/qcdb_small.mtx',]
    ...
    groupBar2.DrawFigure(dataSetNames, errAll, methodTags, "Datasets", "Error (%)",
                         5, 15, figPath + "sec4_1_e2e_1stream1static_lazy_fro", True)
    groupBar2.DrawFigure(dataSetNames, np.log(lat95All), methodTags, "Datasets", "95% latency (ms)",
                         5, 15, figPath + "sec4_1_e2e_1stream1static_lazy_latency_log", True)
    groupBar2.DrawFigure(dataSetNames, np.log(thrAll), methodTags, "Datasets", "elements/ms",
                         5, 15, figPath + "sec4_1_e2e_1stream1static_lazy_throughput_log", True)
