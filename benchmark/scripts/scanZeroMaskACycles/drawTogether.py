...
def main():
    ...
    groupLine.DrawFigureYLog(periodAll*100.0, elapsedTimeAll,
                                ...
                                figPath + "/"  + "nnz_lat",
                                True)
    groupLine.DrawFigureYnormal(periodAll*100.0, froAll*100.0,
                                methodTags,
    ...
    ppMemStallAll=memStallAll/cpuCycleAll
    groupLine.DrawFigureYnormal(periodAll*100.0, elapsedTimeAll,
                                methodTags,
                                "Propotion of left-top NNZ rows and columns (%)", "Realtive amount of latency", 0, 1,
                                figPath + "/"  + "nnz_lat_relative",
                                True)
    groupLine.DrawFigureYnormal(periodAll*100.0, totalStallAll/cpuCycleAll*100.0,
                                methodTags,
                                "Propotion of left-top NNZ rows and columns (%)", "Propotion of Stall cycles (%)", 0, 1,
                                figPath + "/"  + "nnz_total_stall",
                                True)
    groupLine.DrawFigureYnormal(periodAll*100.0, otherStallsAll/cpuCycleAll,
                                methodTags,
                                "Propotion of left-top NNZ rows and columns (%)", "Realtive amount of \n Cache Stall cycles", 0, 1,
                                figPath + "/"  + "nnz_other_stall",
                                True)
    groupLine.DrawFigureYnormal(periodAll*100.0, ppMemStallAll,
                                methodTags,
                                "Propotion of left-top NNZ rows and columns (%)", "Realtive amount of \n Mem Stall cycles", 0, 1,
                                figPath + "/"  + "nnz_mem_stall",
                                True)
